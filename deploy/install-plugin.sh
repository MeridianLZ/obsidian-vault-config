...
echo "  Both activation paths (plugin AND repo-level) read this vault-root .mcp.json —"
echo "  single source, so the servers register exactly once. See DEPLOY.md Step 2."
